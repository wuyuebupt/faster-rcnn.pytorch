...
## new cmd v2
python trainval_net.py --dataset coco --net res50 --bs 4 --lr 4e-3 --nw 0 --lr_decay_step 4 --epochs 10  --cuda --config  cfgs/res50.yml --data_dir /work/tmp/coco/h5data_gt/ --save_dir /work/save_dir/ --pretrained_model /work/tmp/coco/pretrained_model/resnet50-caffe.pth --cag --neighbor_move 0.3 --cls_weight 0.5 --bbox_weight 10 --cls_beta_weight 0.5 --bbox_beta_weight 50 --kl_weight 1 --reduce_dimension 256 --cag --reg_neighbor --mGPUs --cls_neighbor --reg_reduce_d --alpha_same_with_beta --sigma_geometry 0.3 --cls_alpha_option 2
