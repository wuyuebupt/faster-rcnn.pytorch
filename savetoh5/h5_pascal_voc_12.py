...
def image_proposal_path_from_index(index):
    """
    Construct an image path from the image's "index" identifier.
    """
    # image_path = os.path.join('./data/VOCdevkit/VOC2007/', 'Proposals',
    #                           index + '.mat')
    image_path = os.path.join('./data/VOCdevkit2012//VOC2012/', 'Proposals',
                              index + '.mat')
...
def image_path_from_index(index):
    ...
    Construct an image path from the image's "index" identifier.
    """
    # image_path = os.path.join('./data/VOCdevkit/VOC2007/', 'JPEGImages',
    image_path = os.path.join('./data/VOCdevkit2012/VOC2012/', 'JPEGImages',
                              index + '.jpg')
    assert os.path.exists(image_path), \
        'Path does not exist: {}'.format(image_path)
    return image_path
...
def write_images():
    ...
    # load imge paths
    imglist = './data/VOCdevkit2012/VOC2012/ImageSets/Main/trainval.txt'
    ...
    output_h5 = 'savetoh5/trainval2012.h5'
...
def read_images():
    output_h5 = 'savetoh5/trainval12.h5'
